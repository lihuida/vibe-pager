...
把飞书、钉钉、微信、Telegram 接到本机的 Cursor 或 Codex，人离开电脑也能继续干活。

Agent 跑完一轮，结果推到你正在用的聊天软件；你在手机里回一句任务，指令会交回电脑上的 IDE，接着改、接着跑。通道是遥控器，工位上的 Cursor / Codex 才是执行端。

不用守着屏幕等 Agent。出门、开会、回家路上，都能收结果、下指令，vibe 不断线。

macOS 菜单栏小工具，要求 **macOS 13+**。原生 SwiftUI，不是网页，也不是套壳浏览器。
